...
Interconnect::Interconnect(InstructionList& stack, InstructionList& writeCacheStack, List& readStackList,  List& cacheReadList, InstructionList& responseStack, int schedulingPolicy) {
    this->stack = &stack; 
